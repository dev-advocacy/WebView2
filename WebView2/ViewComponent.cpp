...
ViewComponent::ViewComponent(CWebBrowserDlg* appWindow,IDCompositionDevice* dcompDevice,winrtComp::Compositor wincompCompositor,bool isDcompTargetMode) :
    m_appWindow(appWindow),
    m_controller(appWindow->GetWebViewController()),
